...
import { MinusIcon, PiggyBankIcon, PlusCircleIcon, PlusIcon } from "@phosphor-icons/react";
...
type SavingsLogRow = { sourceId: string; currency: string; value: string };
...
export function SavingsCta({ viewedMonth, homeCurrency, sources }: SavingsCtaProps) {
  ...
  function updateRow(idx: number, field: keyof SavingsLogRow, val: string) {
